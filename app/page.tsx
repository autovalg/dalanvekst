...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#000080] text-white">
      ...
      {/* MOBILE HERO */}
      <section className="relative z-[10] mx-auto flex min-h-[calc(100vh-92px)] w-full max-w-[420px] flex-col items-center justify-center px-5 pb-12 pt-12 text-center md:hidden">
        <button
          type="button"
          onClick={() => {
        ...
        <p className="mt-4 max-w-[24ch] text-[14px] leading-[1.7] tracking-[-0.01em] text-white/68">
          Nettsider, budskap og systemer som gjør det enklere for kunden å ta kontakt.
        </p>
